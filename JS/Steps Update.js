...
// 创建bosjs实例
const bos = new bosjs.BosClient();

// 读取存储的数据
bos.read('Sport'， (err， data) => {
  if (!err && data) {
    const [savedAccount， savedPassword， savedMaxSteps， savedMinSteps， notifyOption] = data.split('@');
